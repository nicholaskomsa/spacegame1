...
public:
	...
	static const std::string mDefaultIncomingPW;
	static const unsigned short mDefaultServerPort;
	static const unsigned short mDefaultClientPort;
...
protected:
	...
	unsigned short mMaxConnections{ 0 };
...
public:
	...
	void startup(unsigned short maxConnections, std::string incomingPW = mDefaultIncomingPW, RakNet::TimeMS timeout = 30'000, unsigned short port = mDefaultServerPort) {
...
public:
	...
	bool connect(std::string ip, std::string password = mDefaultIncomingPW, unsigned short maxConnections = 1, unsigned short serverPort = mDefaultServerPort, unsigned short clientPort = mDefaultClientPort) {
